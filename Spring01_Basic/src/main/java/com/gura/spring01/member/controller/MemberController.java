...
import com.gura.spring01.member.MemberDto;
...
public class MemberController {
	...
	public String insert(HttpServletRequest request) {
		/*
		 * 	[ 요청 파라미터 추출하는 방법 1 ]
		 * 	HttpServletReaquest 객체를 Controller 메소드로 전달받아서 직접 추출한다.
		 */
	...
	public String insert2(int num, String name, String addr) {
		 ...
		 *  <input name="email"> 이면 String email 이런 식으로 선언 하면된다.
		 *  
	...
	public String insert3(MemberDto dto) {
		 ...
		 *  }
		 *  
		 *  insert(@MedelAttrubute MemberDto dto) 에서 @MedelAttribute 가 생략된 형태이다.
		 */
