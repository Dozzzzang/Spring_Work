...
public class MemberController {
	...
	public String update(MemberDto dto) {
		//service 를 이용해서 회원 한명의 정보 수정
		service.updateMember(dto);		
		return "member/update";
	}
	
	@RequestMapping("/member/updateform")
	public ModelAndView updateform(int num, ModelAndView mView) {//MedelAndView 객체도 받을수 있다.
		//service 를 이용해서 회원 한명의 정보를 ModelAndView 객체에 담는다.
	...
	public ModelAndView getList(ModelAndView mView) {
		...
		// service 를 이용해서 회원 전체 목록을 ModelAndView 객체에 담는다.
